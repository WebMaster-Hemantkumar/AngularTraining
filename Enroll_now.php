...
$course_applied_for=$_POST['course_applied_for'];
        ...
        $message="<p> Dear Sir</p>
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%' >
                  ...
                  <tr><td>course applied for&nbsp;</td><td> : </td><td>".$course_applied_for."</td></tr>
                </table>
                <p>Thanks & best regards:<br/>
                   ".$name."</p>";
                  
    $to = "hemantbly.kumar@gmail.com";
 ...
 send_mail($to, $subject, $message,$mobile,$email,$name);
        ...
        $name1="ThinkYard";
        $Mailfrm="hemantbly.kumar@gmail.com";
 ...
 // echo "done";
  header("location: index.html?msg=Your query submited");
?> 
